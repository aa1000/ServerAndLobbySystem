...
#include "RnDCharacter.generated.h"

UCLASS(config=Game)
class ARnDCharacter : public ACharacter
{
	GENERATED_BODY()
	...
	class AUsableItem* UsableInView;
	...
	FORCEINLINE bool ServerUseItem_Validate() { return true; }
